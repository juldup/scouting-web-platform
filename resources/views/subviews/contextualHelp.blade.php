...
@if ($help == 'payment')
  <p>Cette page permet de noter le status de paiement des membres aux activités de la section.</p>
  <h3>Ajouter une activité</h3>
  <p>Pour ajouter une activité, encode le nom de l'activité et clique sur <strong>Ajouter</strong>.</p>
  <p>Il ne peut y avoir qu'une seule activité du même nom.</p>
  <h3>Les informations de la grille</h3>
  <p>Chaque ligne correspond à un membre de la section (les animateurs sont au bas de la liste).</p>
  <p>Chaque colonne correspond à une activité.</p>
  <p><strong>Cliquer sur une case</strong> change le status (payé &#8644; non payé). Il est possible de changer toute une colonne d'un seul clic.</p>
  <p>Le total de paiements/non paiements par membre est affiché. Le total par activité est également affiché en bas.</p>
  <p>S'il y a plus de 6 activités, seules les 6 dernières seront affichées. Il est alors possible de naviguer avec les flèches <strong>&lt;&lt;&lt;</strong> et <strong>&gt;&gt;&gt;</strong>.</p>
@endif
...
@if ($help == 'edit-documents')
  ...
  <p>
     ...
     contacte le <a href="{{ URL::route('personal_email', array('contact_type' => 'webmaster', 'member_id' => 0)) }}">webmaster du site</a>.
  </p>
@endif
