    ...
    <div class='col-md-5'>
      ...
      <table class=''>
        <tbody>
          ...
          <tr>
            <th>Charte des animateurs</th>
            <td>
              <span class='horiz-divider'></span>
                <a href='{{ URL::route('leader_policy') }}' class='btn btn-default'><span class='glyphicon glyphicon-eye-open'></span></a>
              &nbsp;
              @if ($user->can(Privilege::$EDIT_PAGES, 1))
                <a href='{{ URL::route('edit_leader_policy_page') }}' class='btn btn-primary'><span class='glyphicon glyphicon-edit'></span></a>
              @endif
            </td>
          </tr>
          <tr>
