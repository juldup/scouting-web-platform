...
@section('body')
  ...
  <p>
    Vous avez redemandé le lien d'activation de votre compte d'utilisateur <strong>{{ $username }}</strong> sur le site de l'unité {{ Parameter::get(Parameter::$UNIT_SHORT_NAME) }}. Le voici&nbsp;:<br />
