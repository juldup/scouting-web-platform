 ...
 */
window.savePhotoOrder = function(table, photoOrder) {
  $.ajax({
    type: "POST",
 ...
 */
window.deletePhoto = function(photoButton) {
 ...
 */
window.draggingOverPhotoDropArea = function(event) {
 ...
 */
window.draggingOverPhotoDropAreaDone = function(event) {
 ...
 */
window.selectPicturesManually = function() {
 ...
 */
window.picturesManuallySelected = function() {
 ...
 */
window.addPictures = function(event) {
  event.preventDefault();
 ...
 */
window.addPicturesFromList = function(files) {
 ...
 */
window.uploadNextPicture = function() {
  ...
  if (picturesToUpload.length !== 0) {
    ...
    var fileData = picturesToUpload.shift();
 ...
 */
window.initRotateButtons = function($container) {
 ...
 */
window.rotatePicture = function(photoId, clockwise) {
  $.ajax({
      url: rotatePhotoURL,
      type: "GET",
