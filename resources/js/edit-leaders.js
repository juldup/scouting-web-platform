 ...
 */
window.addLeader = function(sectionId) {
 ...
 */
window.dismissMemberForm = function() {
  $("#member_form").slideUp();
}
 ...
 */
window.editOwnData = function(leaderId) {
 ...
 */
window.editLeader = function(leaderId, scoutToLeader) {
  if (scoutToLeader)
 ...
 */
window.showEditLeaderForm = function(form, leaderId) {
