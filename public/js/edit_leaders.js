...
function addLeader(sectionId) {
  ...
  $("#member_form [name='has_handicap']").prop("checked", false);
  $("#member_form [name='handicap_details']").val("");
  $("#member_form [name='comments']").val("");
  $("#member_form [name='leader_name']").val("");
  $("#member_form [name='leader_in_charge']").prop("checked", false);
  ...
  $("#member_form [name='phone_member_private']").prop("checked", false);
...
function editLeader(leaderId) {
  ...
  $("#member_form [name='has_handicap']").prop("checked", leaders[leaderId].has_handicap);
  ...
  $("#member_form [name='leader_in_charge']").prop("checked", leaders[leaderId].leader_in_charge);
  ...
  $("#member_form [name='phone_member_private']").prop("checked", leaders[leaderId].phone_member_private);
