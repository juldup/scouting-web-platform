...
@if ($help == 'edit-attendance')
  <legend>Présences @yield('back_to_top')</legend>
  <p>
    Cet outil permet de cocher les présences des membres aux activités de l'année, une bonne manière de garder une trace.
  </p>
@endif
