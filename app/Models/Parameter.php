...
class Parameter extends Model {
  ...
  public static $REGISTRATION_GENERIC_SECTIONS = "Registration generic sections";
  ...
  public static $SHOW_LEADER_POLICY = "Show leader policy";
  public static $SHOW_GDPR = "Show GDPR";
