...
Route::get('gestion/inscription/formulaire/{section_slug?}', array("as" => "edit_registration_form", "uses" => "RegistrationController@editForm"));
Route::post('gestion/inscription/formulaire/{section_slug?}', array("as" => "edit_registration_form_submit", "uses" => "RegistrationController@saveForm"));
...
Route::get('gestion/inscription/reinitialisation-cotisations/{status}', array("as" => "set_all_suscription_fees", "uses" => "RegistrationController@setAllSubscriptionFees"));
...
Route::get('gestion/absences/inscription-emails/{member_id}/{section_slug?}', array("as" => "register_to_absence_emails", "uses" => "AbsenceController@registerToAbsenceEmails"));
Route::get('gestion/absences/desinscription-emails/{member_id}/{section_slug?}', array("as" => "unregister_from_absence_emails", "uses" => "AbsenceController@unregisterFromAbsenceEmails"));
