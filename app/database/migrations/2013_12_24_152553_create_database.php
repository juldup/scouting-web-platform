...
class CreateDatabase extends Migration {
    ...
    DB::table('parameters')->insert(array('name' => Parameter::$REREGISTRATION_ACTIVE, 'value' => 'true'));
    DB::table('parameters')->insert(array('name' => Parameter::$GROUPED_SECTION_MENU, 'value' => 'false'));
    DB::table('parameters')->insert(array('name' => Parameter::$SHOW_ADDRESSES, 'value' => 'true'));
    DB::table('parameters')->insert(array('name' => Parameter::$SHOW_ANNUAL_FEAST, 'value' => 'false'));
    ...
    DB::table('parameters')->insert(array('name' => Parameter::$SHOW_GUEST_BOOK, 'value' => 'false'));
    DB::table('parameters')->insert(array('name' => Parameter::$SHOW_ABSENCES, 'value' => 'true'));
    ...
    DB::table('parameters')->insert(array('name' => Parameter::$SHOW_LEADER_POLICY, 'value' => 'true'));
